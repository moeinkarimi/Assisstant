...
public class MainActivity extends AppCompatActivity {
    ...
    LinearLayout btnGroup, btnRecord, btnBuild, btnTable, btnReading, btnShowPerson;
    ImageView imageView, imageView8, imageView3, imageView4, imageView5, imageView6, imageView7;
